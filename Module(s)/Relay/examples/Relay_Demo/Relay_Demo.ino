...
void loop()
{
    Relay_State_Set(Relay_1, Relay_State_On);
    Relay_State_Set(Relay_2, Relay_State_On);
    _delay_ms(2000);
    Relay_State_Set(Relay_1, Relay_State_Off);
    Relay_State_Set(Relay_2, Relay_State_Off);
    _delay_ms(2000);
}
