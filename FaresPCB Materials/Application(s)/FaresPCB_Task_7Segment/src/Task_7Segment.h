...
#ifndef FARESPCB_TASK_7SEGMENT_H_
#define FARESPCB_TASK_7SEGMENT_H_
...
typedef struct __attribute__((packed, aligned(1))) Task_7Segment_Request_t
{
    uint16_t value; //  0 - 9999
} Task_7Segment_Request_t;
...
#endif /* FARESPCB_TASK_7SEGMENT_H_ */
